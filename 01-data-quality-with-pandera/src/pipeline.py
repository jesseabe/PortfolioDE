...
from etl_estoque import extrai_dados_estoque, transforma_dados_estoque, carrega_dados_estoque
from etl_vendas import extrai_dados_vendas, transforma_dados_vendas, carrega_dados_vendas
...
def run_etl_compras():
    ...
    if not df.empty:
        ...
        carrega_dados_compras(df_transformado)
...
def run_etl_estoque():
    ...
    if not df.empty:
        ...
        carrega_dados_estoque(df_transformado)
...
def run_etl_vendas():
    ...
    if not df.empty:
        ...
        carrega_dados_vendas(df_transformado)
